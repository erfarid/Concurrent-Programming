...
public class Farm {
    ...
    private synchronized void initializeFarm(int numberOfSheep, int numberOfDogs) {
    ...
    private synchronized void placeSheepAndDogs(int numberOfSheep, int numberOfDogs) {
